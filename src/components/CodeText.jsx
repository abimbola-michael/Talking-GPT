...
export default function CodeText({ message }) {
  ...
  return (
    <div className="flex flex-col border-1 rounded-md border-lightest-black">
      <div className="flex justify-between items-center px-3 py-1 bg-lightest-black text-sm">
        <span>{language}</span>
